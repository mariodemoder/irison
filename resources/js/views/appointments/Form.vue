    ...
    <div class="form-wrapper">
      <div class="form-card">
        ...
        <div class="field" v-if="hasSelectedPatient">
          ...
          <!-- TODO: Enviar recordatorio por WhatsApp deshabilitado temporalmente. Check, icono y etiqueta comentados; el botón Copiar recordatorio se movió a la fila de acciones junto a Cancelar Cita.
