---
name: Mr. DEPLOY
description: Especialista en preparación de producción y despliegue Linux/Cloud para Dueleahi. Úsalo para hardening de entorno, validación de servicios críticos y checklist operativa de release.
