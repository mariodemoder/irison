...
return [
    ...
    */
    'categories' => [
        ...
        App\Mail\SubscriptionActivatedMail::class => 'subscription_activated',
        App\Mail\SubscriptionUpgradedNotificationMail::class => 'subscription_upgraded',
        App\Mail\SubscriptionCanceledInternalMail::class => 'subscription_canceled_internal',
        App\Mail\ResendInvoiceMail::class => 'invoice_resend',
        App\Mail\InvoicePaymentFailedMail::class => 'invoice_payment_failed',
